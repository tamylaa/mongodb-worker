      ...
      let maybeSecondRequest = request.clone(), routeToUserWorker = async ({
        ...
        return eyeballConfig.limitedAssetsOnly ? (analytics.setData({ userWorkerFreeTierLimiting: !0 }), new Response(renderLimitedResponse(maybeSecondRequest), {
          ...
          if (analytics.setData({
            ...
            let resp = await env.USER_WORKER.fetch(maybeSecondRequest), isImage = resp.headers.get("content-type")?.startsWith("image/"), isPlainText = resp.headers.get("content-type") === "text/plain";
            return !isImage && !isPlainText && resp.status !== 304 ? (analytics.setData({ abuseMitigationBlocked: !0 }), new Response("Blocked", { status: 403 })) : resp;
          }
